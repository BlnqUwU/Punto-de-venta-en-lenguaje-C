...
servidor: servidor.c funciones_servidor.c funciones_admin.c utilidades.c 
	gcc servidor.c funciones_servidor.c funciones_admin.c utilidades.c  -o servidor -pthread -lncurses
